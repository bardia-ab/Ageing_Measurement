...
MMCM1 = CM(fin=50e6, D=4, M=127, O=127, mode='incremental', fpsclk=50e6)
MMCM2 = CM(fin=MMCM1.fout, D=1, M=128, O=32, mode='decremental', fpsclk=50e6)
MMCM3 = CM(fin=MMCM1.fout, D=1, M=128, O=32)
T = 1 / MMCM2.fout
